# Sugra MCP example: TypeScript agent
...
2. It calls `listTools` to discover the eleven Sugra tools and maps each tool's
...
- Prefer Python? See the sibling [python-agent](../python-agent/) example.
